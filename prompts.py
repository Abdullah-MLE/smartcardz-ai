...
def get_word_agent_system_prompt() -> str:
    ...
    return '\n'.join([
        ...
        "- \"warning\": null",
        "- \"suggestions\": null",
        "- Fill all content fields (\"description\", \"types\", \"examples\", \"image_prompt\") according to instructions.",
        "",
        ...
        "- \"suggestions\": Single string of 3 comma-separated alternatives in the requested language.",
        "",
        "# Content Instructions (Only for Valid Words)",
        "- Types: SINGLE STRING containing grammatical parts of speech separated by commas (e.g., \"Noun, Verb\").",
        "- Description: Explain meaning tailored to age/level. **DO NOT** mention the [Target Word].",
        "- Examples: SINGLE STRING containing real-life sentences separated by commas. **MUST include** the [Target Word].",
        ...
        "  \"is_valid\": true,",
        "  \"types\": \"Noun, Verb (or null if invalid)\",",
